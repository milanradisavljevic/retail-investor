  ...
  const models: ModelEntry[] = [
    {
      ...
      note: 'Momentum-Only Strategy: Pure technical indicators (13-week & 26-week returns)',
    },
    {
      key: 'hybrid',
      label: 'Hybrid',
      ...
      note: 'Hybrid Strategy: Combines momentum with 52-week position scoring',
    },
    {
      key: '4pillar',
      label: '4-Pillar',
      ...
      note: '4-Pillar Strategy: Full scoring model (Valuation, Quality, Technical, Risk)',
    },
    {
      key: 'momentum-cap',
      ...
      summary: null,
      timeSeries: [],
      note: 'Not yet calculated - filters for market cap > $500M',
    },
    {
      key: 'momentum-vol',
      ...
      summary: null,
      timeSeries: [],
      note: 'Not yet calculated - filters for volatility < 50%',
    },
  ];
