#!/usr/bin/env python3
"""
Test DCF Formulas with yfinance Data

Same test as test_dcf_real_stocks.py but using yfinance instead of Finnhub.
This validates that our yfinance adapter works correctly with the DCF formulas.
"""
...
def main():
    """Run DCF test with yfinance data."""
    print_section("DCF TEST WITH YFINANCE DATA")

    # Test universe (same as Finnhub test for comparison)
    test_symbols = [
    ...
    print_section("COMPARISON WITH FINNHUB")
    print("Run test_dcf_real_stocks.py with Finnhub to compare results.")
    print("Expected: Similar intrinsic values (±10-20% due to data differences)")
    print()
