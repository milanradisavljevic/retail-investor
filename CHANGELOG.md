...
- **README-Screenshot-Set für neue Features aktualisiert (Codex):** Ich (Codex) habe `README.md` erweitert, damit die neuen Funktionen visuell direkt sichtbar sind: Portfolio (inkl. Diversifikations-Dashboard), Macro Context (Heatmap/Rates) und Homepage-Übersicht mit Market Context + Earnings-Widget aus `latest screenshots/`.
